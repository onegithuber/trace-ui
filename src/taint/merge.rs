...
pub fn merge_all_chunks(
    ...
    let mut chunk_string_accesses: Vec<Vec<(u64, u64, u8, u32, crate::taint::strings::StringRw)>> = Vec::with_capacity(num_chunks);
...
mod tests {
    ...
    fn test_merge_string_indices() {
        use crate::taint::strings::{StringIndex, StringRecord, StringEncoding, StringRw};
